...
import com.hw3.controller.TokenController;
...
public class TokenMenu {
    ...
    public void tokenMenu() {
        ...
        System.out.println("토크 처리 전 글자 : " + str);
        System.out.println("토크 처리 전 개수 : " + str.length());
        System.out.println("토크 처리 후 글자 : " + tc.afterToken(str));
        System.out.println("토크 처리 후 개수 : " + tc.afterToken(str).length());
